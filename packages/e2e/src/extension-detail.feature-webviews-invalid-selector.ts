...
export const name = 'extension-detail.feature-webviews-invalid-selector'

export const test: Test = async ({ expect, Extension, ExtensionDetail, Locator }) => {
  // arrange
  const extensionUri = import.meta.resolve('../fixtures/extension-webviews-invalid-selector')
  await Extension.addWebExtension(extensionUri)
  await ExtensionDetail.open('test.webviews-invalid-selector')
  ...
  await expect(item2Value).toHaveText('{"value":[".test-webviews"]}')
